    ...
    <div class="app-header">
      ...
      <div class="instellingen-kaart">
          ...
          <div class="onderdelen-grid onderdelen-grid-instellingen">
              ...
              <button class="onderdeel-knop" :class="{ 'knop-uit': !toonOpleidingen }" @click="toonOpleidingen = !toonOpleidingen">Welke opleiding en cursussen heb ik gedaan?</button>
      ...
      <div v-if="toonOpleidingen">
          <div class="hoofdtitel-wrapper">
              ...
              <h2 class="hoofdtitel">Welke opleiding en cursussen heb ik gedaan?</h2>
          </div>
